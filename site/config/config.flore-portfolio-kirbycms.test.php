...
return [
    // Enable debug
    'debug' => true,
    // Assets path correction for Ngrok
    'url' => isset($_SERVER['HTTP_X_FORWARDED_HOST']) ? $_SERVER['HTTP_X_FORWARDED_PROTO'] . '://' . $_SERVER['HTTP_X_FORWARDED_HOST'] : 'https://flore-portfolio-kirbycms.test',
    // Enable multi-language for kirby to use
    'languages' => true,
    // Clean url for project pages (remove "home/" from urls)
    'routes' => [
        [
            'pattern' => '(:any)',
            'language' => '*',
    ...
    // Basic responsive configuration for images
    'thumbs' => [
        'srcsets' => [
            'default' => [
                '300w'  => ['width' => 300],
